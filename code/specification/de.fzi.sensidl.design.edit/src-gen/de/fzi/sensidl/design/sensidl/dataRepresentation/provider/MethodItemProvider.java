...
/**
 * This is the item provider adapter for a {@link de.fzi.sensidl.design.sensidl.dataRepresentation.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReturnTypeDataSetPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_dataSet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_dataSet_feature", "_UI_Method_type"),
				 DataRepresentationPackage.Literals.METHOD__DATA_SET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_parameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_parameter_feature", "_UI_Method_type"),
				 DataRepresentationPackage.Literals.METHOD__PARAMETER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataRepresentationPackage.Literals.METHOD__RETURN_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataRepresentationPackage.Literals.METHOD__VISIBILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Return Type Data Set feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReturnTypeDataSetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_returnTypeDataSet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_returnTypeDataSet_feature", "_UI_Method_type"),
				 DataRepresentationPackage.Literals.METHOD__RETURN_TYPE_DATA_SET,
				 true,
				 false,
				 true,
				 null,
