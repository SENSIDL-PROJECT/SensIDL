...
/**
 * This is the item provider adapter for a {@link de.fzi.sensidl.design.sensidl.DataRepresentation.DataField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFieldItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataRepresentationPackage.Literals.DATA_FIELD__DATA_TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataField.class)) {
			case DataRepresentationPackage.DATA_FIELD__DATA_TYPE:
