...
/**
 * This is the item provider adapter for a {@link sensidl.Representation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepresentationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addByteCountPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Byte Count feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addByteCountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Representation_byteCount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Representation_byteCount_feature", "_UI_Representation_type"),
				 SensidlPackage.Literals.REPRESENTATION__BYTE_COUNT,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Representation_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Representation_type_feature", "_UI_Representation_type"),
				 SensidlPackage.Literals.REPRESENTATION__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SensidlPackage.Literals.REPRESENTATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
