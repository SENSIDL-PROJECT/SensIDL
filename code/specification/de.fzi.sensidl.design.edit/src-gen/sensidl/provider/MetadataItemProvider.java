...
/**
 * This is the item provider adapter for a {@link sensidl.Metadata} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetadataItemProvider extends DatafieldItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metadata_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metadata_type_feature", "_UI_Metadata_type"),
				 SensidlPackage.Literals.METADATA__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addRepresentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metadata_representation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metadata_representation_feature", "_UI_Metadata_type"),
				 SensidlPackage.Literals.METADATA__REPRESENTATION,
				 true,
				 false,
				 true,
				 null,
