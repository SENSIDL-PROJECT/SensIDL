 ...
 * <ul>
 *   <li>{@link sensidl.impl.DataAdaptionImpl#getScalingFactor <em>Scaling Factor</em>}</li>
 *   <li>{@link sensidl.impl.DataAdaptionImpl#getOffset <em>Offset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DataAdaptionImpl extends DataConstraintImpl implements DataAdaption {
	/**
	...
	protected EClass eStaticClass() {
		return SensidlPackage.Literals.DATA_ADAPTION;
	}
	...
	public void setScalingFactor(Double newScalingFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensidlPackage.DATA_ADAPTION__SCALING_FACTOR, oldScalingFactor, scalingFactor));
	}
	...
	public void setOffset(Double newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensidlPackage.DATA_ADAPTION__OFFSET, oldOffset, offset));
	}
