 ...
 * <ul>
 *   <li>{@link sensidl.impl.CommandImpl#getName <em>Name</em>}</li>
 *   <li>{@link sensidl.impl.CommandImpl#getStructure <em>Structure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandImpl extends MinimalEObjectImpl.Container implements Command {
	...
	protected EClass eStaticClass() {
		return SensidlPackage.Literals.COMMAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensidlPackage.COMMAND__NAME, oldName, name));
	}
