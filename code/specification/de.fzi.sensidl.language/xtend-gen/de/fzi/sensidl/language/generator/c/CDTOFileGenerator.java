...
public class CDTOFileGenerator extends CDTOGenerator {
  ...
  public CDTOFileGenerator(final Resource input, final IFileSystemAccess fsa) {
    super(input, fsa);
  }
    ...
    for (final DataSet dataset : _filter_2) {
      {
        ...
        CDTOFileGenerator.logger.info(((("File: " + fileName) + " was generated in ") + SensIDLOutputConfigurationProvider.SENSIDL_GEN));
