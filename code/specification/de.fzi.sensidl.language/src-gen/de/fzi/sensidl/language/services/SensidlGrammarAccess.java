...
public class SensidlGrammarAccess extends AbstractGrammarElementFinder {
	...
	private SensorInterfaceElements pSensorInterface;
	private EncodingSettingsElements pEncodingSettings;
	private CodingElements unknownRuleCoding;
	private EndiannessElements unknownRuleEndianness;
	private SensorDataDescriptionElements pSensorDataDescription;
	private DataSetElements pDataSet;
	private DataElements pData;
	private MeasurementDataElements pMeasurementData;
	private NonMeasurementDataElements pNonMeasurementData;
	private DataTypeElements unknownRuleDataType;
	private DataAdjustmentElements pDataAdjustment;
	private DataRangeElements pDataRange;
	private IntervalElements pInterval;
	private DataConversionElements pDataConversion;
	private LinearDataConversionElements pLinearDataConversion;
	private LinearDataConversionWithIntervalElements pLinearDataConversionWithInterval;
	...
	public SensorInterfaceElements getSensorInterfaceAccess() {
		return (pSensorInterface != null) ? pSensorInterface : (pSensorInterface = new SensorInterfaceElements());
	}
	...
	public EncodingSettingsElements getEncodingSettingsAccess() {
		return (pEncodingSettings != null) ? pEncodingSettings : (pEncodingSettings = new EncodingSettingsElements());
	}
	...
	public CodingElements getCodingAccess() {
		return (unknownRuleCoding != null) ? unknownRuleCoding : (unknownRuleCoding = new CodingElements());
	}
	...
	public EndiannessElements getEndiannessAccess() {
		return (unknownRuleEndianness != null) ? unknownRuleEndianness : (unknownRuleEndianness = new EndiannessElements());
	}
	...
	public SensorDataDescriptionElements getSensorDataDescriptionAccess() {
		return (pSensorDataDescription != null) ? pSensorDataDescription : (pSensorDataDescription = new SensorDataDescriptionElements());
	}
	...
	public DataSetElements getDataSetAccess() {
		return (pDataSet != null) ? pDataSet : (pDataSet = new DataSetElements());
	}
	...
	public MeasurementDataElements getMeasurementDataAccess() {
		return (pMeasurementData != null) ? pMeasurementData : (pMeasurementData = new MeasurementDataElements());
	}
	...
	public NonMeasurementDataElements getNonMeasurementDataAccess() {
		return (pNonMeasurementData != null) ? pNonMeasurementData : (pNonMeasurementData = new NonMeasurementDataElements());
	}
	...
	public DataAdjustmentElements getDataAdjustmentAccess() {
		return (pDataAdjustment != null) ? pDataAdjustment : (pDataAdjustment = new DataAdjustmentElements());
	}
	...
	public DataRangeElements getDataRangeAccess() {
		return (pDataRange != null) ? pDataRange : (pDataRange = new DataRangeElements());
	}
	...
	public DataConversionElements getDataConversionAccess() {
		return (pDataConversion != null) ? pDataConversion : (pDataConversion = new DataConversionElements());
	}
	...
	public LinearDataConversionElements getLinearDataConversionAccess() {
		return (pLinearDataConversion != null) ? pLinearDataConversion : (pLinearDataConversion = new LinearDataConversionElements());
	}
	...
	public LinearDataConversionWithIntervalElements getLinearDataConversionWithIntervalAccess() {
		return (pLinearDataConversionWithInterval != null) ? pLinearDataConversionWithInterval : (pLinearDataConversionWithInterval = new LinearDataConversionWithIntervalElements());
	}
