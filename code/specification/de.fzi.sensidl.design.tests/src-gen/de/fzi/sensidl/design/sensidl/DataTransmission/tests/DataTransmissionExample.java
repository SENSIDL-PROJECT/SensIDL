...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>DataTransmission</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DataTransmissionExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DataTransmissionPackage.eNS_URI, 
			 DataTransmissionPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.datatransmission"));
				SensorDataTransmission root = DataTransmissionFactory.eINSTANCE.createSensorDataTransmission();
