...
import de.fzi.sensidl.generator.job.GenerationJobFactory
 ...
 */
class SensidlCodeGenerationExecutor implements de.fzi.sensidl.generator.ISensidlCodeGenerator {
	...
	override doGenerate(Resource input, IFileSystemAccess fsa) {
		...
		val generationJob = GenerationJobFactory.getGenerationJobBy(new de.fzi.sensidl.generator.GenerationParameter(input, fsa, generationLanguage));
