package de.fzi.sensidl.generator.factory.java.unittest
...
class JavaUnitTestGenerator implements ICodeGenerator {
	...
	override generateDTO(List<DataSet> dataSet) {
		new de.fzi.sensidl.generator.factory.java.unittest.JavaUnitTestDTOGenerator(dataSet, packagePrefix).generate
	}
